...
plt.show()
#compare the images
compare_images_plot(original, original, "Original vs. Original")
compare_images_plot(original, desaturated, "Original vs. Contrast")
compare_images_plot(original, shopped, "Original vs. Photoshopped")